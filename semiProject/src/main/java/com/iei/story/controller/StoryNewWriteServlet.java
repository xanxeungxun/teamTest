...
/**
 * Servlet implementation class storyNewWriteServlet
 */
@WebServlet(name = "StoryWrite1", urlPatterns = { "/storyNewWrite.do" })
public class StoryNewWriteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StoryNewWriteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result>0) { //작품 등록 성공
			...
			request.setAttribute("msg", "작품이 성공적으로 등록되었습니다.");
