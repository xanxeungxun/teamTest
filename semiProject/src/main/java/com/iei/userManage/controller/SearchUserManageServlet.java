...
// 질문 목록 조회
@WebServlet(name = "SearchUserManage", urlPatterns = { "/userManage/searchUserManage.do" })
public class SearchUserManageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		UserManagePageData paramVo = new UserManagePageData();
		...
		UserManagePageData qpd = service.selectSearchedUserManage(reqPage,paramVo);
		//4 결과처리
